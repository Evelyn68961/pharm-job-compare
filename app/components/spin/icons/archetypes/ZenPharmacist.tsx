...
export function ZenPharmacist({ size, accentColor }: ArchetypeComponentProps) {
  return (
    ...
    >
      ...
      <path d="M32 51.5 C30.5 49 27.5 49.5 29 52 C27.5 54.5 30.5 55 32 52.5 Z" fill="#059669" />
      <path d="M32 51.5 C33.5 49 36.5 49.5 35 52 C36.5 54.5 33.5 55 32 52.5 Z" fill="#059669" />
      <path d="M31.5 53 Q30 55 31 56.5" stroke="#059669" strokeWidth="0.8" fill="none" strokeLinecap="round" />
      <path d="M32.5 53 Q34 55 33 56.5" stroke="#059669" strokeWidth="0.8" fill="none" strokeLinecap="round" />
      <circle cx="32" cy="52" r="0.75" fill="#047857" />
      <path d="M68 51.5 C66.5 49 63.5 49.5 65 52 C63.5 54.5 66.5 55 68 52.5 Z" fill="#059669" />
      <path d="M68 51.5 C69.5 49 72.5 49.5 71 52 C72.5 54.5 69.5 55 68 52.5 Z" fill="#059669" />
      <path d="M67.5 53 Q66 55 67 56.5" stroke="#059669" strokeWidth="0.8" fill="none" strokeLinecap="round" />
      <path d="M68.5 53 Q70 55 69 56.5" stroke="#059669" strokeWidth="0.8" fill="none" strokeLinecap="round" />
      <circle cx="68" cy="52" r="0.75" fill="#047857" />
