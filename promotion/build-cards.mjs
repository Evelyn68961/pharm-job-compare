...
const BASE_TAGS = ['#藥師', '#醫院藥師', '#藥師人生', '#藥師人格圖鑑'];
const IDOL_TAG = {
...
const SERIES = [
  ...
  { wk: 4, no: '10', date: 'Mon Aug 17', type: 'idol', k: '教魂',
    scen: ['帶學生比自己上班還累', '但看他們成長就充電'], recog: '⋯這是你的日常嗎？',
    factors: ['教學醫院資源', '帶教制度與時數', '進修・研討公假公費'], fate: '你的命運醫院是哪間教學醫院？' },
  { wk: 4, no: '11', date: 'Wed Aug 19', type: 'cmp', a: '佛系', b: '金牛',
    aLine: '佛系：錢夠用就好，心不累最重要', bLine: '金牛：拚一波，年薪百萬是信仰',
    metrics: ['月薪帶', '加班程度', '生活品質'] },
  { wk: 4, no: '12', date: 'Fri Aug 21', type: 'grid',
    body: ['藥師人格圖鑑 · 全員集合', '', '7 種藥師人格，你是幾號？', '',
      '1. 學霸 · 醫學中心衝一波', '2. 教魂 · 帶學生比自己還累', '3. 北漂 · 一卡皮箱闖天涯',
      '4. 鐵腕 · 公職鐵飯碗', '5. 夜貓 · 大夜換高薪', '6. 佛系 · 準時下班就是勝利',
      '7. 金牛 · 年薪百萬是信仰', '', '留言你的號碼，我猜下一位 👇'].join('\n') },
  { wk: 5, no: '13', date: 'Mon Aug 24', type: 'cmp', a: '教魂', b: '學霸',
    aLine: '教魂：帶學生，看他們發光', bLine: '學霸：拚研究，看自己發表',
    metrics: ['教學制度', '研究資源', '進修公假'] },
  { wk: 5, no: '14', date: 'Wed Aug 26', type: 'cmp', a: '學霸', b: '佛系',
    aLine: '學霸：資源拉滿，也累到不行', bLine: '佛系：準時下班，也錯過光環',
    metrics: ['成長資源', '工時強度', '升遷天花板'] },
  { wk: 5, no: '15', date: 'Fri Aug 28', type: 'grid',
    body: ['藥師人格圖鑑 · 7 種藥師的一天', '', '同樣是藥師，一天差很多？', '',
  ...
  { wk: 6, no: '16', date: 'Mon Aug 31', type: 'cmp', a: '金牛', b: '北漂',
    aLine: '金牛：住在家附近，賺得穩穩的', bLine: '北漂：離鄉背井，拚高薪 + 宿舍',
    metrics: ['薪資帶', '宿舍補助', '通勤成本'] },
  { wk: 6, no: '17', date: 'Wed Sep 2', type: 'cmp', a: '北漂', b: '鐵腕',
    aLine: '北漂：離家闖，高薪 + 宿舍加成', bLine: '鐵腕：留在家，公職鐵飯碗穩穩的',
    metrics: ['起薪', '生活成本', '長期保障'] },
  { wk: 6, no: '18', date: 'Fri Sep 4', type: 'grid',
    body: ['藥師人格圖鑑 · 薪水 × 生活 座標圖', '', '把 7 種藥師放上「薪水 × 生活」地圖：', '',
      '💰 金牛：拿得出高薪，還想兼顧生活',
      '😴 夜貓：高薪但爆肝，用命換錢',
      '📚 學霸：資源拉滿，但也累到不行',
      '🛡️ 鐵腕：中薪但穩，保障是最強護城河',
      ...
      '🎒 北漂：離家追高薪 + 宿舍，先卡位', '',
      '你落在哪個象限？留言告訴我 👇'].join('\n') },
  { wk: 7, no: '19', date: 'Mon Sep 7', type: 'cmp', a: '夜貓', b: '金牛',
    aLine: '夜貓：用大夜換錢，肝爆爆', bLine: '金牛：靠簽約金和津貼疊，健康還在',
    metrics: ['夜班費', '簽約金', '身體代價'] },
  { wk: 7, no: '20', date: 'Wed Sep 9', type: 'cmp', a: '佛系', b: '鐵腕',
    title: '佛系 vs 鐵腕：兩種「穩定」你選哪個？',
    aLine: '佛系：私立準時下班，錢夠用', bLine: '鐵腕：公職鐵飯碗，退休有保障',
    metrics: ['月薪帶', '工時保障', '退休制度'] },
  { wk: 7, no: '21', date: 'Fri Sep 11', type: 'grid',
    body: ['藥師人格圖鑑 · 完結篇', '', '7 週、21 篇、7 種藥師人格。', '你，找到自己了嗎？', '',
