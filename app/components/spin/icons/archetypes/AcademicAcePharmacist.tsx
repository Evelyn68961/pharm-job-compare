...
export function AcademicAcePharmacist({ size }: ArchetypeComponentProps) {
  return (
    ...
    >
      ...
      <path d="M50 55 L44 67 L50 73 L56 67 Z" fill="#5EC8C2" />
      ...
      <g transform="rotate(-9 26 76)">
        <rect x="15" y="63" width="22" height="27" rx="2" fill="#F4F1EA" stroke="#9AA1AB" strokeWidth="1.6" />
        <rect x="22" y="60" width="8" height="5" rx="1.5" fill="#9AA1AB" />
